...
OCHuman_17 = {
    'Nose':0, 'L_Eye':1, 'R_Eye':2, 'L_Ear':3, 'R_Ear':4, 'L_Shoulder':5, 'R_Shoulder':6, 'L_Elbow':7, 'R_Elbow':8, 'L_Wrist':9, 'R_Wrist':10, \
...
ochuman_connMat = np.array([[28, 26], [26, 24], [24, 25], [25, 27],
                            [48, 12],
                            [12, 17], [17, 19], [19, 21],
                            [12, 16], [16, 18], [18, 20],
                            [45, 5], [5, 8],
                            [46, 4], [4, 7]])
cm_ochuman = np.array([[255,0,0],[255,0,0],[255,0,0],[255,0,0],
                        [225, 225, 0],
...
crowdpose_connMat = np.array([[16, 18], [18, 20], [17, 19], [19, 21],
                                [46, 4], [4, 7], [45, 5], [5, 8],
                                [48, 47]])
cm_crowdpose = np.array([[255,0,0],[255,0,0],[255,0,0],[255,0,0],
                        [225, 225, 0],[225, 225, 0],[225, 225, 0],[225, 225, 0],
                        [255,0,255]])
################################################################################################################################################################
...
dataset_involved = ['h36m', 'mupots', 'pw3d', 'mpiinf', 'jta','cmup', 'oh','mpiinf_test', 'pw3d_pc', 'pw3d_nc','pw3d_oc','pw3d_vibe', 'pw3d_normal','agora','mini','pw3d_od', 'oh50k']
dataset_kp2ds = ['h36m', 'mupots', 'pw3d', 'mpiinf', 'jta','cmup', 'oh','mpiinf_test', 'pw3d_pc', 'pw3d_nc','pw3d_oc','pw3d_vibe', 'pw3d_normal','agora','mini','relativity', 'aich', 'crowdpose','pw3d_od', 'oh50k']
dataset_smpl2lsp = ['h36m', 'cmup','mpiinf','mpiinf_test', 'jta', 'pw3d_nc','pw3d_oc','pw3d_vibe'] #'pw3d', 
MPJAE_ds = ['pw3d_normal', 'h36m', 'oh50k']
PVE_ds = ['pw3d_pc', 'pw3d_nc','pw3d_oc','pw3d_vibe', 'pw3d_normal', 'oh','agora','mini', 'oh50k']
