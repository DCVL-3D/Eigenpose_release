...
from .ochuman import OCHuman
from .oh50k import OH50K
...
dataset_dict = {'h36m': H36M, 'mpii': MPII, 'coco': COCO14, 'posetrack':Posetrack21, 'aich':AICH, 'pw3d':PW3D, 'up':UP, 'crowdpose':Crowdpose, 'crowdhuman':CrowdHuman, \
    ...
    'cmup':CMU_Panoptic_eval,'internet':Internet, 'relative_human': Relative_human, 'agora':AGORA, 'ochuman': OCHuman, 'oh50k': OH50K}
