    ...
    class OH50K(Base_Classes[base_class]):
        ...
        def get_image_info(self, index):
            ...
            if self.regress_smpl:
                ...
                # camkp3d = np.array(info['smpl_joints_3d'].copy())
                # print('1'*20, camkp3d.shape)
                # extri = np.array(info['extri'].copy())
                # camkp3d = np.matmul(extri[:3,:3], camkp3d.T).T + extri[:3,3]
                # print(camkp3d.shape)
            ...
            camMats = np.array(self.annots[img_name]['intri'])
