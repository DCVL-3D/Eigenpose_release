...
class SMPLWrapper(nn.Module):
    def __init__(self):
        ...
        self.part_idx = [args().cam_dim, args().rot_dim,  (args().smpl_joint_num-1)*3,       10]
    ...
    def forward(self, outputs, meta_data):
        ...
        for i,  (idx, name) in enumerate(zip(self.part_idx,self.part_name)):
            ...
            # print("########################## name, idx, idx_list[i], idx_list[i+1]: ", name, idx, idx_list[i], idx_list[i+1])
        ...
        # print("params_dict['betas']: ", params_dict['betas'].shape) # B, 10
        # print("params_dict['poses']: ", params_dict['poses'].shape) # B, 72
        # print("########## verts in smpl_wrapper: ", vertices.shape) # B, 6890, 3
